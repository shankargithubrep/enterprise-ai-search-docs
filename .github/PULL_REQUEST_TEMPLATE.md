...
- [ ] **Configuration Reference** table covers all parameters with types, defaults, and Enterprise-specific notes
...
- [ ] Enterprise-specific details (tenant counts, instance types, prefix structure) match the current spec
