...
ServiceNow's default rate limit is typically 10,000 requests per hour per user — both sync patterns are well within this for the the customer 5,000-articles-per-tenant baseline.
